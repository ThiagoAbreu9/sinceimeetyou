...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'sinceImeetYou';
  ...
  'jhipster.mail.from' = 'sinceImeetYou@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'sinceImeetYou API';
  'jhipster.swagger.description' = 'sinceImeetYou API documentation';
  ...
  'eureka.instance.appname' = 'sinceImeetYou';
  'eureka.instance.instanceId' = 'sinceImeetYou:${random.value}';
  ...
  'cloud.config.name' = 'sinceImeetYou';
